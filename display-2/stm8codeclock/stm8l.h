...
#define CFG_GCR_AL(N) ((N) << 1)
#define CFG_GCR_SWD(N) ((N) << 0)
...
#define CLK_CRTCR_RTCDIV(N) ((N)<<5)
#define CLK_CRTCR_RTCSEL(N) ((N)<<1)
#define CLK_CRTCR_RTCSWBSY (1<<0)

#define CLK_ECKCR_LSERDY (1<<3)
...
#define LCD_PM ((unsigned char*)0x5404)
#define LCD_RAM ((unsigned char*)0x540C)

#define LCD_CR2_PON(N) ((N) << 5)
#define LCD_CR2_HD(N) ((N) << 4)
#define LCD_CR2_CC(N) ((N) << 1)
#define LCD_CR2_VSEL(N) ((N) << 0)

#define LCD_CR3_LCDEN(N) ((N) << 6)
#define LCD_CR3_SOFIE(N) ((N) << 5)
#define LCD_CR3_SOF(N) ((N) << 4)
#define LCD_CR3_SOFC(N) ((N) << 3)
#define LCD_CR3_DEAD(N) ((N) << 0)

#define LCD_FRQ_PS(N) ((N) << 4)
#define LCD_FRQ_DIV(N) ((N) << 0)
...
#define RTC_CR1_FMT(N) ((N) << 6)
#define RTC_CR1_RATIO(N) ((N) << 5)
#define RTC_CR1_BYPSHAD(N) ((N) << 4)
#define RTC_CR1_WUCKSEL(N) ((N) << 0)

#define RTC_CR2_WUTIE(N) ((N) << 6)
#define RTC_CR2_ALRAIE(N) ((N) << 4)
#define RTC_CR2_WUTE(N) ((N) << 2)
#define RTC_CR2_ALRAE(N) ((N) << 0)


#define RTC_ISR1_INIT(N) ((N) << 7)
#define RTC_ISR1_INITF (1 << 6)
#define RTC_ISR1_WUTWF (1 << 2)

#define RTC_ISR2_WUTF (1 << 2)